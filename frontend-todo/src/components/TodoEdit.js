...
const TodoEdit = ({ todo }) => {
   ...
   const updateDescription = async (e) => {
    ...
    try{
        ...
        const response = await fetch(`http://localhost:5000/api/todo/${todo._id}`, {
            method: "PUT",
 ...
 <button type="button" className="btn btn-primary" data-toggle="modal" data-target={`#id${todo._id}`} onClick={() => setDescription(todo.description)}>
  Edit
</button>
